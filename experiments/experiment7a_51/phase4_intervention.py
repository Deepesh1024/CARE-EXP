...
def run_interventions():
    ...
    csv_path = os.path.join(INTERVENTION_DIR, "sample_manifest.csv")
    ...
    # Interventions
    results = []
    out_csv = os.path.join(INTERVENTION_DIR, "replication_results.csv")
    ...
    for i, row in sampled_df.iterrows():
        ...
        results.append({
            ...
            "base_loss": base_loss,
            "int_loss": int_loss,
            "baseline_margin": base_logit_margin,
            "ablated_margin": int_logit_margin,
            "delta_acc": delta_acc,
            "delta_loss": delta_loss,
            "margin_damage": delta_logit_margin
        })
