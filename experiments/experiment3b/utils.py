...
# ──────────────────────────────────────────────
_ALL_DIRS = [RESULTS_DIR, FIGURES_DIR]
...
def save_fig(fig, name: str) -> str:
    """Saves a matplotlib figure as high-DPI PNG and vector PDF."""
    png_path = os.path.join(FIGURES_DIR, f"{name}.{FIGURE_FORMAT}")
